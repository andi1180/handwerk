...
/** Client-Timeout: der Render darf etwas dauern (ffmpeg + Upload), aber nie ewig hängen. */
const REEL_TEST_TIMEOUT_MS = 180_000;

/**
 * Provisorischer FFmpeg-Infra-Test (Schritt 8b-0): POST auf `render-reel-test`,
 * zeigt bei Erfolg einen Link zum erzeugten Test-mp4. KEIN echtes Reel — beweist
 * nur, dass ffmpeg in der Vercel-Function läuft und der Output im Storage landet.
 * Wird in 8b-1 durch das echte „Reel erstellen" ersetzt. Lade-/Fehler-State via
 * try/finally (nie ein Dauer-„Rendere…"), mit AbortController-Timeout.
 */
